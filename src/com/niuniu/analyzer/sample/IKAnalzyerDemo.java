...
public class IKAnalzyerDemo {
	...
	public static void main(String[] args){
		...
		try {
			...
			//
			//ts = analyzer.tokenStream("myfield", new StringReader("gl 260丰田黑顶棚320li39.96国产"));
			//ts = analyzer.tokenStream("myfield", new StringReader("揽胜行政3.0汽油39.96很好320却不如320li和2010款以及宝马16款216系98款"));
			ts = analyzer.tokenStream("myfield", new StringReader("gl8"));
			//获取词元位置属性
